...
var START_URL = "http://partagecampina.com.br/site/filme/gaby-estrella/";
var pagesVisited = {};
var pagesToVisit = [];
...
function collectMovies($) {
  var mDetails = [];
  var mSession = [];
  var mTitle = "Título: " + $('html > body').find('div > h1.page_title').text();
  ...
  movie = movieJSON(mDetails, mSession);
  console.log(movie);
  return movie;
}
